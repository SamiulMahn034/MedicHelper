...
<body class="container" style="height:850px; background-image: linear-gradient(#2E3192,  #1BFFFF);">
...
<form style="width:400px;" action="auth_doctor.php" method="get">
  <div class="mb-3">
  ...
  <div class="mb-3">
    <a style="color:white; text-decoration:none;" href="signup_doctor.php">Not Registered</a>
